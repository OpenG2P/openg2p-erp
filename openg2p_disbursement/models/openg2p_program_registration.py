...
class HrRegistration(models.Model):
    """
    Beneficiary registration based on the visa, work permits
    allows to configure different Disbursement structure
    """
    _inherit = 'openg2p.program.registration'
    _description = 'Beneficiary Registration'
    ...
    def get_all_structures(self):
        """
        @return: the structures linked to the given registrations, ordered by hierachy (parent=False first,
