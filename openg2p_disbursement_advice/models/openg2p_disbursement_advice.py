...
class DisbursementAdvice(models.Model):
    ...
    _sql_constraints = [
        ('uniq_bank_per_batch', 'unique (batch_id,bank_id)',
    ...
    def compute_advice(self):
        ...
        if len(slips) < 1000:
            ...
            return {
                ...
                'message': _('Generation of the disbursement advice has been queued for processing'),
            }
    ...
    def action_execute(self):
        ...
        if self.bank_id.execute_method == 'manual':
            ...
            return self.env.ref('openg2p_disbursement_advice.disbursement_advice').report_action(self)
            ...
            raise UserError(_(
                "No handler for this payment method."))
