...
class ResConfigSettings(models.TransientModel):
    ...
    module_openg2p_disenrollment = fields.Boolean(
        string="Track Beneficiary Disenrollments"
    )
    ...
    module_openg2p_disbursement_reconciliation = fields.Boolean(
        string="Disbursement Reconciliation tools"
    )
    ...
    beneficiary_id_sequence = fields.Many2one(
        "ir.sequence", related="company_id.beneficiary_id_sequence"
    )
