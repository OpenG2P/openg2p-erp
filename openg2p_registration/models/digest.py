...
class Digest(models.Model):
    ...
    def _compute_kpi_openg2p_registration_new_beneficiaries_value(self):
        if not self.env.user.has_group('openg2p_registration.group_openg2p_registration_user'):
    ...
    def compute_kpis_actions(self, company, user):
        ...
        res[
            'kpi_openg2p_registration_new_beneficiaries'] = 'openg2p.open_view_beneficiary_list_my&menu_id=%s' % self.env.ref(
